...
function getAspectsFromParameters() {
  ...
  var aspectsFileIndex = process.argv.indexOf('--aspects') + 1;
...
module.exports = function (_ref) {
  ...
  var aspectsFile = getAspectsFromParameters();
  ...
  context.aspect = function (rule, advice) {
    var transformed = babel.transform(advice.toString());
    ...
    aspects.push({
      ...
      params: transformed.ast.program.body[0].params.map(function (param) {
        return param.name;
      })
    });
  };
